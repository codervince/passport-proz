...
Strategy.prototype.userProfile = function(accessToken, done) {
    ...
    this._oauth2.get(url, accessToken, function(err, body, res) {
        ...
        try {
            ...
            profile.uuid = json.response.uuid;
            profile.email = json.response.email;
            profile.site_name = json.response.site_name;
            profile.membershipExpires = json.proz_membership.expiration_date;
            profile.status = json.proz_membership.status;
            profile._raw = body;
            profile._json = json;
